 ...
 *         -removes case endings form nouns and adjectives, possesive adj.
 *         endings from names,
 *         diminutive, augmentative, comparative sufixes and derivational
 *         sufixes from nouns,
    ...
    private void removeCase(StringBuffer buffer) {
        ...
        if (len > 5) {
            ...
            if (buffer.substring(len - 3, len).equals("\u00e9ho") || // -ého
                    ...
                    buffer.substring(len - 3, len).equals("\u00e9mu") || // -ému buffer.substring(
